<template>
    <PageComponent>
        ...
        <div v-if="surveys.loading" role="status" class="flex justify-center">
            <svg
                aria-hidden="true"
        ...
        <div v-else>
            <div class="grid grid-cols-1 gap-3 sm:gid-cols-2 md:grid-cols-3">
                <SurveyListItem
...
function deleteSurvey(survey) {
    if (
        confirm(
            `Are you are you want to delete this survey? The operation can't be undone!!`
        )
    ) {
